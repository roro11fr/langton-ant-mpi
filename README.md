...
Nota: rularile `P=8/16` facute local cu oversubscription au fost scoase din setul final pentru a evita interpretari gresite. Pentru `P=8/16` corect, reruleaza acele cazuri pe cluster real.
